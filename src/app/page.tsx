...
const workflowCards = [
  ...
  {
    title: "ผู้ดูแลระบบ",
    description: "เตรียมข้อมูลหลักสูตร รายวิชา prerequisite แผนรายเทอม และวิชาที่เปิดสอนก่อนให้นักศึกษาใช้วิเคราะห์",
    steps: ["ตรวจความพร้อมข้อมูล", "นำเข้า CSV", "พร้อมให้ระบบวิเคราะห์"]
  },
  {
