...
const workflowSteps: Array<{
  ...
  },
  {
    key: "publish",
    step: "8",
    title: "ตรวจความพร้อมก่อนเผยแพร่",
    shortTitle: "ตรวจความพร้อม",
    detail: "ตรวจผลสุดท้ายว่าอะไรครบ อะไรยังขาด อะไรผิด และพร้อมให้นักศึกษาใช้วิเคราะห์หรือยัง"
  }
];
...
function getNextStepDetail(currentStep: AdminStepKey) {
  if (currentStep === "offerings") {
    return "เมื่อกำหนดวิชาที่เปิดสอนครบแล้ว ให้ไปตรวจความพร้อมก่อนเผยแพร่ เพื่อดูว่าข้อมูลพร้อมให้นักศึกษาใช้วิเคราะห์หรือยัง";
  }
